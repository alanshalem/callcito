...
// Radix emite `data-state="checked"|"unchecked"`. Tailwind v4 matcha via
// `data-[state=checked]:` (no `data-checked:` — esa variante NO existe).
function Switch({
  className,
  size = "default",
  ...props
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          ...
          "dark:group-data-[state=checked]/switch:bg-primary-foreground dark:group-data-[state=unchecked]/switch:bg-foreground"
        )}
      />
    </SwitchPrimitive.Root>
  )
